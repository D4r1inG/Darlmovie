...
import { layDanhSachNguoiDung, themNguoiDungAction } from '../../redux/actions/QuanLyNguoiDungAction';
    ...
    return (
        ...
        <div className=" bg-gray-100 flex py-10 justify-center ">
            <div className=" max-w-screen-lg mx-auto">
                <div>
                    <h2 className="font-semibold text-xl text-gray-600">Thêm người dùng</h2>
                            ...
                            <div className="lg:col-span-2">
                                <form onSubmit={formik.handleSubmit} className="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-5">
                                    <div className="md:col-span-3">
                                        ...
                                        <input type="text" name="hoTen" id="hoTen" className="h-10 border mt-1 rounded px-4 w-full bg-gray-50" onChange={formik.handleChange} />
                                    ...
                                    <div className="md:col-span-2">
                                        ...
                                        <input type="text" name="email" id="email" className="h-10 border mt-1 rounded px-4 w-full bg-gray-50" placeholder="email@domain.com" onChange={formik.handleChange} />
                                    ...
                                    <div className="md:col-span-3">
                                        ...
                                        <input type="text" name="taiKhoan" id="taiKhoan" className="h-10 border mt-1 rounded px-4 w-full bg-gray-50" onChange={formik.handleChange} />
                                    ...
                                    <div className="md:col-span-2">
                                        ...
                                        <input type="text" name="matKhau" id="matKhau" className="h-10 border mt-1 rounded px-4 w-full bg-gray-50" onChange={formik.handleChange} />
                                    ...
                                    <div className="md:col-span-2">
                                        ...
                                        <input type="text" name="soDt" id="soDt" className="transition-all flex items-center h-10 border mt-1 rounded px-4 w-full bg-gray-50" onChange={formik.handleChange} />
                                    ...
                                    <div className="md:col-span-2">
                                        ...
                                        <Select defaultValue="KhachHang" style={{ width: 120, display: 'block', marginTop: '.5rem' }} onChange={handleChangeLoaiNguoiDung} >
